...
| `MNEMOSYNE_PREFETCH_CJK_STOP_UNITS` | built-in CJK function-word units | Complete replacement for the CJK units ignored when canonical slots are matched, on both canonical paths; does not affect working/episodic prefetch |
